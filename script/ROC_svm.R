...
ggroc(roc.list, legacy.axes = TRUE) + geom_abline() + ggtitle("SVM ROC curve e1071") + geom_line(size=2.5)
...
roc.list <- list("1950-1960"=rs_test[[1]],"1950-1970"=rs_test[[2]],
                 ...
                 "1980-1990"=rs_test[[13]],"1980-2000"=rs_test[[14]],
                 "1990-2000"=rs_test[[15]])
ggroc(roc.list, legacy.axes = TRUE) + geom_abline() + ggtitle("SVM ROC curve caret") + geom_line(size=2.5)
